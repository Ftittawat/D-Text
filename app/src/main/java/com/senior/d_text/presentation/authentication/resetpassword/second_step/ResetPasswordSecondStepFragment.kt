...
import com.senior.d_text.databinding.FragmentResetPasswordSecondStepBinding
import com.senior.d_text.presentation.authentication.resetpassword.third_step.ResetPasswordThirdStepFragment
...
class ResetPasswordSecondStepFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        vm = ViewModelProvider(this)[ResetPasswordSecondStepViewModel::class.java]
    }
