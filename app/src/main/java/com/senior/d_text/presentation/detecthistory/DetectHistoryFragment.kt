...
import com.senior.d_text.databinding.FragmentDetectHistoryBinding

class DetectHistoryFragment : BottomSheetDialogFragment() {

    private lateinit var binding: FragmentDetectHistoryBinding
    private lateinit var vm: DetectHistoryViewModel
    ...
    override fun onCreateView(
        ...
        binding = FragmentDetectHistoryBinding.inflate(layoutInflater)
        vm = ViewModelProvider(this)[DetectHistoryViewModel::class.java]
        return binding.root
    }
